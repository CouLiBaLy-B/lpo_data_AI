...
class DatabaseConnection:
    ...
    def _initialize_pool(self):
        ...
        try:
            ...
            logger.info(
                f"Pool de connexions initialisé avec {self.pool_size} connexions"
            )
    ...
    def get_connection(self):
        ...
        try:
            ...
            raise DatabaseException(
                f"Erreur lors de l'utilisation de la connexion: {e}"
            )
        finally:
            if conn:
                try:
    ...
    def execute_query(self, query: str, params: tuple = None) -> List[Dict[str, Any]]:
        ...
        try:
            with self.get_connection() as conn:
                ...
                logger.info(
                    f"Requête exécutée en {execution_time:.3f}s: {query[:100]}..."
                )
                return results
    ...
    def get_table_info(self, table_name: str) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            raise DatabaseException(
                f"Erreur lors de la récupération des infos table: {e}"
            )
    ...
    def get_table_list(self) -> List[str]:
        ...
        try:
            ...
            raise DatabaseException(
                f"Erreur lors de la récupération de la liste des tables: {e}"
            )
    ...
    def _get_table_indexes(self, table_name: str) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            logger.warning(
                f"Erreur lors de la récupération des index pour {table_name}: {e}"
            )
            return []
