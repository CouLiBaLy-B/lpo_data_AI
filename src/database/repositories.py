...
class SensitiveAreasRepository(BaseRepository):
    ...
    def get_regions_stats(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            raise DatabaseException(f"Erreur lors de la récupération des stats régions: {e}")
    ...
    def get_structures_stats(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            raise DatabaseException(f"Erreur lors de la récupération des stats structures: {e}")
    ...
    def get_practices_stats(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            raise DatabaseException(f"Erreur lors de la récupération des stats pratiques: {e}")
    ...
    def get_creation_timeline(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            raise DatabaseException(f"Erreur lors de la récupération de la timeline: {e}")
...
class DatabaseRepository:
    ...
    def get_query_stats(self, query: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {'estimated_rows': 0, 'complexity': 'unknown', 'query_type': 'unknown'}
    ...
    def _get_query_type(self, query: str) -> str:
        ...
        if 'COUNT(' in query_upper:
            return 'count'
        elif 'SUM(' in query_upper or 'AVG(' in query_upper or 'MAX(' in query_upper or 'MIN(' in query_upper:
            return 'aggregate'
